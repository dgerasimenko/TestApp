...
(
    ...
    baggage_info character varying(10000) COLLATE pg_catalog."default",
    ...
    counter character varying(10000) COLLATE pg_catalog."default",
    ...
    gate_info character varying(10000) COLLATE pg_catalog."default",
    lounge_info character varying(10000) COLLATE pg_catalog."default",
    ...
    terminal_info character varying(10000) COLLATE pg_catalog."default",
    arr_terminal_info character varying(10000) COLLATE pg_catalog."default",
    created_at bigint,
...
(
    ...
    aircraft_name_scheduled text COLLATE pg_catalog."default",
    baggage_info character varying(128) COLLATE pg_catalog."default",
    counter character varying(128) COLLATE pg_catalog."default",
    gate_info character varying(128) COLLATE pg_catalog."default",
    lounge_info character varying(128) COLLATE pg_catalog."default",
    terminal_info character varying(128) COLLATE pg_catalog."default",
    arr_terminal_info character varying(128) COLLATE pg_catalog."default",
    source_data text COLLATE pg_catalog."default",
